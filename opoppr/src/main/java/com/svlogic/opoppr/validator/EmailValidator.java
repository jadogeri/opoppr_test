 ...
 * @author David
 */
@FacesValidator("com.svlogic.opoppr.validator.Email")
public class EmailValidator implements Validator
{
    ...
    {
        String str = (String)o;
        Pattern p = Pattern.compile("([_A-Za-z0-9-\\+]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9-]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,}))" + (notRequired ? "?" : ""));
        Matcher m = p.matcher(str);
        if (!m.matches()) {
            FacesMessage msg = Messages.getMessage("com.svlogic.opoppr.Messages",
                                                   "com.svlogic.opoppr.validator.EmailValidator",
