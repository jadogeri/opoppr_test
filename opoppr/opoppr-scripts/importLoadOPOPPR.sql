...
LOAD DATA LOCAL INFILE '/tmp/import.csv' INTO TABLE noa_pp_lat5_temp FIELDS TERMINATED BY '|' ENCLOSED BY '\"' lines terminated by '\n' IGNORE 1 LINES;
...
SELECT a.account_id, 1, CONCAT(t.taxyr, ' LAT 5'), t.taxyr, 1 from account as a inner join noa_pp_lat5_temp as t on a.bill_number = t.altid;
